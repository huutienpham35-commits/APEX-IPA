    ...
    static func restore(
        ...
        do {
            ...
            try restoreRecords(
                ...
                roots: roots,
                // The target app can legitimately rewrite a patched file after it
                // launches. The original backup is still digest-verified below, so
                // restore it even when the current file no longer matches the patch.
                requirePatchedDigest: false,
